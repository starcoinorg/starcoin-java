...
public abstract class Transaction {
    ...
    public static final class BlockMetadata extends Transaction {
        public final org.starcoin.types.BlockMetadata value;

        public BlockMetadata(org.starcoin.types.BlockMetadata value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static BlockMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.starcoin.types.BlockMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.starcoin.types.BlockMetadata value;
